...
passwordToggle.addEventListener('change', function() {
  ...
  <h1 className="font-medium text-3xl text-center py-4 text-gray-800">Sign Portal</h1>
  <label className="font-medium block mb-1 mt-6 text-gray-700" for="username">
    Email
  </label>
  <input className="appearance-none border-2 rounded w-full py-3 px-3 leading-tight border-gray-300 bg-gray-100 focus:outline-none focus:border-indigo-700 focus:bg-white text-gray-700 pr-16 font-mono" id="username" type="text" autocomplete="off" autofocus />
  ...
  <button className="w-full bg-indigo-700 hover:bg-indigo-900 text-white font-medium py-3 px-4 mt-10 rounded focus:outline-none focus:shadow-outline" type="button">
    Sign in
  </button>
